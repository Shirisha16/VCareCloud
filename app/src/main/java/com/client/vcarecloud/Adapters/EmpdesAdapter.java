...
import com.client.vcarecloud.UpdateEmpDesignation;
...
public class EmpdesAdapter extends RecyclerView.Adapter<EmpdesAdapter.MyViewHolder> {
    ArrayList<LookupTypeModel> lookupTypeModelArrayList;
    Context context;
    LoadDetails loadDetails;
    RelativeLayout progressRelative;

    public EmpdesAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @NonNull
    @Override
    public EmpdesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
