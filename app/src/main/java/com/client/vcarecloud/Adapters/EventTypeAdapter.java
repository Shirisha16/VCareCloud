...
import com.client.vcarecloud.UpdateEventType;
...
public class EventTypeAdapter extends RecyclerView.Adapter<EventTypeAdapter.MyViewHolder>{
    ...
    public EventTypeAdapter(ArrayList<EventTypeModel> eventTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @Override
    public void onBindViewHolder(@NonNull EventTypeAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//                Call<String> call=api.delete_eventsType(eventTypeModel.getTypeId(),"0");
