...
import com.client.vcarecloud.UpdateEyeColor;
...
public class EyecolorAdapter extends RecyclerView.Adapter<EyecolorAdapter.MyViewHolder> {
    ArrayList<LookupTypeModel> lookupTypeModelArrayList;
    Context context;
    LoadDetails loadDetails;
    RelativeLayout progressRelative;

    public EyecolorAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @NonNull
    @Override
    public EyecolorAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull EyecolorAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
