...
import com.client.vcarecloud.UpdateHairstyle;
...
public class HairstyleAdapter extends RecyclerView.Adapter<HairstyleAdapter.MyViewHolder>{
    ArrayList<LookupTypeModel> lookupTypeModelArrayList;
    Context context;
    LoadDetails loadDetails;
    RelativeLayout progressRelative;

    public HairstyleAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @NonNull
    @Override
    public HairstyleAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HairstyleAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder { TextView allergy;
