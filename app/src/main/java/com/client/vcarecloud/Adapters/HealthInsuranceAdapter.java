...
import com.client.vcarecloud.UpdateHealthInsurance;
...
public class HealthInsuranceAdapter extends RecyclerView.Adapter<HealthInsuranceAdapter.MyViewHolder>{
    ...
    public HealthInsuranceAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @NonNull
    @Override
    public HealthInsuranceAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HealthInsuranceAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, UpdateHealthInsurance.class);
