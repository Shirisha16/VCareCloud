...
import com.client.vcarecloud.UpdateLookupEventType;
...
public class LookUpEventTypeAdapter extends RecyclerView.Adapter<LookUpEventTypeAdapter.MyViewHolder>{
    ArrayList<EventTypeModel> eventTypeModelArrayList;
    Context context;
    LoadDetails loadDetails;
    RelativeLayout progressRelative;

    public LookUpEventTypeAdapter(ArrayList<EventTypeModel> eventTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @NonNull
    @Override
    public LookUpEventTypeAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LookUpEventTypeAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, UpdateLookupEventType.class);
