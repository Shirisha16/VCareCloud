...
import com.client.vcarecloud.UpdateMedicalCondition;
...
public class MedicalConditionAdapter extends RecyclerView.Adapter<MedicalConditionAdapter.MyViewHolder> {
    ...
    public MedicalConditionAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @NonNull
    @Override
    public MedicalConditionAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MedicalConditionAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, UpdateMedicalCondition.class);
