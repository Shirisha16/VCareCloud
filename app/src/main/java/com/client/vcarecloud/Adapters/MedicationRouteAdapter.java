...
import com.client.vcarecloud.UpdateMedicationRoute;
...
public class MedicationRouteAdapter extends RecyclerView.Adapter<MedicationRouteAdapter.MyViewHolder> {
    ArrayList<LookupTypeModel> lookupTypeModelArrayList;
    Context context;
    LoadDetails loadDetails;
    RelativeLayout progressRelative;

    public MedicationRouteAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @NonNull
    @Override
    public MedicationRouteAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MedicationRouteAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, UpdateMedicationRoute.class);
