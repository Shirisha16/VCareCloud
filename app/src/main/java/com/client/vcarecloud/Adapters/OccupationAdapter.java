...
import com.client.vcarecloud.UpdateOccupation;
...
public class OccupationAdapter extends RecyclerView.Adapter<OccupationAdapter.MyViewHolder> {
    ...
    public OccupationAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @Override
    public void onBindViewHolder(@NonNull OccupationAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, UpdateOccupation.class);
