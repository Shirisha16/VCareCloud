...
import com.client.vcarecloud.UpdatePaymentType;
...
public class PaymentTypeAdapter extends RecyclerView.Adapter<PaymentTypeAdapter.MyViewHolder>{
    ...
    public PaymentTypeAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    @NonNull
    @Override
    public PaymentTypeAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PaymentTypeAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String empid=lookupTypeModel.getEmpid();
                ...
                Intent intent = new Intent(context, UpdatePaymentType.class);
...
//                Call<String> call=vcareApi.delete_paymentType(lookupTypeModel.getLookupsId(),"0");
