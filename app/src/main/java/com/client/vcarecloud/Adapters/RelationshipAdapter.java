...
import com.client.vcarecloud.UpdateRelationship;
...
public class RelationshipAdapter extends RecyclerView.Adapter<RelationshipAdapter.MyViewHolder>{
    ...
    public RelationshipAdapter(ArrayList<LookupTypeModel> lookupTypeModelArrayList, Context context, LoadDetails loadDetails) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, UpdateRelationship.class);
