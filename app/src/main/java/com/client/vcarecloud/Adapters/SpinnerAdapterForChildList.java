...
public class SpinnerAdapterForChildList extends ArrayAdapter<GetChildList> {

    private Context context;
    List<GetChildList> myObjs;
    LayoutInflater inflater;

    public SpinnerAdapterForChildList(Context context, int textViewResourceId, List<GetChildList> myObjs) {
    ...
    public GetChildList getItem(int position){
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent)
    {
        ...
        main_text.setText(myObjs.get(position).getDisplayName());
