...
public class AddAllergy extends AppCompatActivity {
    ...
    AppCompatButton addallergy;

    UserDetails userDetails;
    LookupTypeModel allergyModel;

    String custId,lookupId,lookupType="Allergy",lookupName="",empId="0",createdOn,lastChangedOn,message,errorMessage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addallergy=findViewById(R.id.add);
        progress_layout=findViewById(R.id.progress);

        userDetails = new UserDetails(AddAllergy.this);
        ...
        lookupId=userDetails.getLookupId();
//        lookupType=allergyModel.getLookupType();
//        Toast.makeText(AddAllergy.this, ""+lookupType, Toast.LENGTH_SHORT).show();
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddAllergy.this, Allergy.class);
            ...
            public void onResponse(Call<AddLookupTypeResponse> call, Response<AddLookupTypeResponse> response) {
               if (response.code()==200){
                   if (response.body().getMessage()!=null){
                       ...
                       if (getApplicationContext() != null && !AddAllergy.this.isFinishing()) {
                           androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(AddAllergy.this);
...
//                           Toast.makeText(AddAllergy.this,response.body().getMessage(), Toast.LENGTH_SHORT).show();
//                           startActivity(intent);
//                           finish();
                       }
                   }else{
                       Utils.showAlertDialog(AddAllergy.this,response.body().getErrorMessage(),false);
                   }
                }
            ...
            public void onFailure(Call<AddLookupTypeResponse> call, Throwable t) {
                Toast.makeText(AddAllergy.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
