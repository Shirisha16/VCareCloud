...
public class AddHealthInsurance extends AppCompatActivity {
    ImageView back;
    ...
    String custId,lookupId,lookupType="Health Insurance",lookupName="",empId="0", createdOn,
            lastChangedOn,message,errorMessage;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_health_insurance);

        back=findViewById(R.id.back);
        lookup_name=findViewById(R.id.healthInsurance);
        add=findViewById(R.id.add);
        progress_layout=findViewById(R.id.progress);

        userDetails = new UserDetails(AddHealthInsurance.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddHealthInsurance.this, HealthInsurance.class);
    ...
    private void addHealthInsurance() {
        ...
        call.enqueue(new Callback<AddLookupTypeResponse>() {
            ...
            public void onResponse(Call<AddLookupTypeResponse> call, Response<AddLookupTypeResponse> response) {
                if(response.code()==200){
                    if (response.body().getMessage()!=null){
                        ...
                        if (getApplicationContext() != null && !AddHealthInsurance.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(AddHealthInsurance.this);
                        ...
                        Utils.showAlertDialog(AddHealthInsurance.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<AddLookupTypeResponse> call, Throwable t) {
                Toast.makeText(AddHealthInsurance.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
    ...
    private boolean lookup_name() {
        ...
        if (lookup_name.getText().toString().isEmpty()) {
            lookup_name.setError("Health insurance should not be empty");
