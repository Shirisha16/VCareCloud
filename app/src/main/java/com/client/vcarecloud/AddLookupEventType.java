...
public class AddLookupEventType extends AppCompatActivity {
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDetails = new UserDetails(AddLookupEventType.this);
...
//        typeId=userDetails.getTypeId();
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddLookupEventType.this, EventTypeLookUp.class);
...
//        addEventTypeModel.setTypeId(typeId);
        ...
        call.enqueue(new Callback<AddEventTypeResponse>() {
            ...
            public void onResponse(Call<AddEventTypeResponse> call, Response<AddEventTypeResponse> response) {
                if(response.code()==200){
                    if (response.body().getMessage()!=null){
                        ...
                        if (getApplicationContext() != null && !AddLookupEventType.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(AddLookupEventType.this);
                        ...
                        Utils.showAlertDialog(AddLookupEventType.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<AddEventTypeResponse> call, Throwable t) {
                Toast.makeText(AddLookupEventType.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
