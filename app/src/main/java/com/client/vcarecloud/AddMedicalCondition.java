...
public class AddMedicalCondition extends AppCompatActivity {
    ImageView back;
    ...
    String custId,lookupId,lookupType="Medical Condition",lookupName="",empId="0", createdOn,
            lastChangedOn,message,errorMessage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_medical_condition);

        back=findViewById(R.id.back);
        lookup_name=findViewById(R.id.medical);
        add=findViewById(R.id.add);
        progress_layout=findViewById(R.id.progress);

        userDetails = new UserDetails(AddMedicalCondition.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddMedicalCondition.this, MedicalCondition.class);
    ...
    private void addMedicalCondition() {
        ...
        call.enqueue(new Callback<AddLookupTypeResponse>() {
            ...
            public void onResponse(Call<AddLookupTypeResponse> call, Response<AddLookupTypeResponse> response) {
                if(response.code()==200){
                    if (response.body().getMessage()!=null){
                        ...
                        if (getApplicationContext() != null && !AddMedicalCondition.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(AddMedicalCondition.this);
                        ...
                        Utils.showAlertDialog(AddMedicalCondition.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<AddLookupTypeResponse> call, Throwable t) {
                Toast.makeText(AddMedicalCondition.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
    ...
    private boolean lookup_name() {
        ...
        if (lookup_name.getText().toString().isEmpty()) {
            lookup_name.setError("Medical condition should not be empty");
