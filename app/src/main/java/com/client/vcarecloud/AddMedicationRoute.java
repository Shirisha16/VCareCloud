...
public class AddMedicationRoute extends AppCompatActivity {
    ImageView back;
    ...
    String custId,lookupId,lookupType="Medication Route",lookupName="",empId="0", createdOn,
            lastChangedOn,message,errorMessage;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_medication_route);

        back=findViewById(R.id.back);
        lookup_name=findViewById(R.id.medication);
        add=findViewById(R.id.add);
        progress_layout=findViewById(R.id.progress);

        userDetails = new UserDetails(AddMedicationRoute.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddMedicationRoute.this, MedicationRoute.class);
    ...
    private void addMedicationRoute() {
        ...
        call.enqueue(new Callback<AddLookupTypeResponse>() {
            ...
            public void onResponse(Call<AddLookupTypeResponse> call, Response<AddLookupTypeResponse> response) {
                if(response.code()==200){
                    if (response.body().getMessage()!=null){
                        ...
                        if (getApplicationContext() != null && !AddMedicationRoute.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(AddMedicationRoute.this);
                        ...
                        Utils.showAlertDialog(AddMedicationRoute.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<AddLookupTypeResponse> call, Throwable t) {
                Toast.makeText(AddMedicationRoute.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
    ...
    private boolean lookup_name() {
        ...
        if (lookup_name.getText().toString().isEmpty()) {
            lookup_name.setError("Medication Route should not be empty");
