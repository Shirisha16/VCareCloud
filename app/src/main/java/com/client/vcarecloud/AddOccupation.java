...
public class AddOccupation extends AppCompatActivity {
    ImageView back;
    ...
    String custId,lookupId,lookupType="Occupation",lookupName="",empId="0", createdOn,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lookup_name=findViewById(R.id.occupation);
        add=findViewById(R.id.add);

        userDetails = new UserDetails(AddOccupation.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddOccupation.this, Occupation.class);
    ...
    private void addOccupation() {
        ...
        call.enqueue(new Callback<AddLookupTypeResponse>() {
            ...
            public void onResponse(Call<AddLookupTypeResponse> call, Response<AddLookupTypeResponse> response) {
                if(response.code()==200){
                    if (response.body().getMessage()!=null){
                        ...
                        if (getApplicationContext() != null && !AddOccupation.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(AddOccupation.this);
                        ...
                        Utils.showAlertDialog(AddOccupation.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<AddLookupTypeResponse> call, Throwable t) {
                Toast.makeText(AddOccupation.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
    ...
    private boolean lookup_name() {
        ...
        if (lookup_name.getText().toString().isEmpty()) {
            lookup_name.setError("Occupation should not be empty");
