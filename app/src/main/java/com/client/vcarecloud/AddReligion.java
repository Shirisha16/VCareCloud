...
public class AddReligion extends AppCompatActivity {
    ImageView back;
    ...
    String custId,lookupId,lookupType="Religion",lookupName="",empId="0", createdOn,
            lastChangedOn,message,errorMessage;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_religion);

        back=findViewById(R.id.back);
        progress_layout=findViewById(R.id.progress);
        lookup_name=findViewById(R.id.religion);
        add=findViewById(R.id.add);

        userDetails = new UserDetails(AddReligion.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddReligion.this, Religion.class);
    ...
    private void addReligion() {
        ...
        call.enqueue(new Callback<AddLookupTypeResponse>() {
            ...
            public void onResponse(Call<AddLookupTypeResponse> call, Response<AddLookupTypeResponse> response) {
                if(response.code()==200){
                    if (response.body().getMessage()!=null){
                        ...
                        if (getApplicationContext() != null && !AddReligion.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(AddReligion.this);
                        ...
                        Utils.showAlertDialog(AddReligion.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<AddLookupTypeResponse> call, Throwable t) {
                Toast.makeText(AddReligion.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private boolean lookup_name() {
        ...
        if (lookup_name.getText().toString().isEmpty()) {
            lookup_name.setError("Religion should not be empty");
