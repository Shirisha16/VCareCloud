...
public class AddSpecialNeeds extends AppCompatActivity {
    ImageView back;
    ...
    String custId,lookupId,lookupType="Special Need",lookupName="",empId="0", createdOn,
            lastChangedOn,message,errorMessage;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_special_needs);
        ...
        userDetails = new UserDetails(AddSpecialNeeds.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddSpecialNeeds.this, SpecialNeeds.class);
    ...
    private void addSpecialNeeds() {
        ...
        call.enqueue(new Callback<AddLookupTypeResponse>() {
            ...
            public void onResponse(Call<AddLookupTypeResponse> call, Response<AddLookupTypeResponse> response) {
                if(response.code()==200){
                    if (response.body().getMessage()!=null){
                        ...
                        if (getApplicationContext() != null && !AddSpecialNeeds.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(AddSpecialNeeds.this);
                        ...
                        Utils.showAlertDialog(AddSpecialNeeds.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<AddLookupTypeResponse> call, Throwable t) {
                Toast.makeText(AddSpecialNeeds.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
