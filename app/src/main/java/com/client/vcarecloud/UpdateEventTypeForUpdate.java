...
public class UpdateEventTypeForUpdate extends AppCompatActivity {
    ...
    String id,custId,typeId,typeName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDetails=new UserDetails(UpdateEventTypeForUpdate.this);
...
//                Intent intent=new Intent(UpdateEventTypeForUpdate.this,EventTypeForUpdate.class);
    ...
    private void updateEventTypeDetails() {
        ...
        call.enqueue(new Callback<UpdateEventTypeResponse>() {
            ...
            public void onResponse(Call<UpdateEventTypeResponse> call, Response<UpdateEventTypeResponse> response) {
                if (response.code()==200){
                    if (response.body().getMessage()!=null) {
                        ...
                        if (UpdateEventTypeForUpdate.this != null && !UpdateEventTypeForUpdate.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(UpdateEventTypeForUpdate.this);
                        ...
                        Utils.showAlertDialog(UpdateEventTypeForUpdate.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<UpdateEventTypeResponse> call, Throwable t) {
                Toast.makeText(UpdateEventTypeForUpdate.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
