...
public class UpdateEyeColor extends AppCompatActivity {
    ImageView back;
    TextInputEditText eyecolor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_eye_color);
        ...
        userDetails=new UserDetails(UpdateEyeColor.this);
        ...
        eyecolor.setText(lookupname);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(UpdateEyeColor.this,EyeColor.class);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                lookupname=eyecolor.getText().toString();
    ...
    private boolean lookup_name() {
        String str = eyecolor.getText().toString();
        if (eyecolor.getText().toString().isEmpty()) {
            eyecolor.setError("Eye color should not be empty");
            eyecolor.requestFocus();
            return false;
        } else if(str.length() > 0 && str.startsWith(" ")) {
            eyecolor.setText(eyecolor.getText().toString().trim());
            eyecolor.setSelection(eyecolor.getText().length());
            return false;
        }
        else {
            return true;
    ...
    private void updateEyecolor() {
        ...
        call.enqueue(new Callback<UpdateLookupTypeResponse>() {
            ...
            public void onResponse(Call<UpdateLookupTypeResponse> call, Response<UpdateLookupTypeResponse> response) {
              if(response.code()==200){
                  if (response.body().getMessage()!=null){
                      ...
                      if (UpdateEyeColor.this!=null&&!UpdateEyeColor.this.isFinishing()) {
                          androidx.appcompat.app.AlertDialog.Builder builder= new androidx.appcompat.app.AlertDialog.Builder(UpdateEyeColor.this);
                      ...
                      Utils.showAlertDialog(UpdateEyeColor.this,response.body().getErrorMessage(),false); }
              }
            ...
            public void onFailure(Call<UpdateLookupTypeResponse> call, Throwable t) {
                Toast.makeText(UpdateEyeColor.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
