...
public class UpdateLookupEventType extends AppCompatActivity {
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDetails=new UserDetails(UpdateLookupEventType.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(UpdateLookupEventType.this,EventTypeLookUp.class);
    ...
    private void updateEventTypeDetails() {
        ...
        call.enqueue(new Callback<UpdateEventTypeResponse>() {
            ...
            public void onResponse(Call<UpdateEventTypeResponse> call, Response<UpdateEventTypeResponse> response) {
                if (response.code()==200){
                    if (response.body().getMessage()!=null) {
                        ...
                        if (UpdateLookupEventType.this != null && !UpdateLookupEventType.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(UpdateLookupEventType.this);
                        ...
                        Utils.showAlertDialog(UpdateLookupEventType.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<UpdateEventTypeResponse> call, Throwable t) {
                Toast.makeText(UpdateLookupEventType.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
