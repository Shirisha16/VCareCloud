...
public class UpdateMedicationRoute extends AppCompatActivity {
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_medication_route);
        ...
        userDetails=new UserDetails(UpdateMedicationRoute.this);
        ...
        medication.setText(lookupname);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(UpdateMedicationRoute.this,MedicationRoute.class);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lookupname=medication.getText().toString();
    ...
    private void updateMedicationRoute() {
        ...
        call.enqueue(new Callback<UpdateLookupTypeResponse>() {
            ...
            public void onResponse(Call<UpdateLookupTypeResponse> call, Response<UpdateLookupTypeResponse> response) {
                if (response.code() == 200) {
                    if (response.body().getMessage() != null) {
                        ...
                        if (UpdateMedicationRoute.this != null && !UpdateMedicationRoute.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(UpdateMedicationRoute.this);
                        ...
                        Utils.showAlertDialog(UpdateMedicationRoute.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<UpdateLookupTypeResponse> call, Throwable t) {
                Toast.makeText(UpdateMedicationRoute.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private boolean lookup_name() {
        String str = medication.getText().toString();
        if (medication.getText().toString().isEmpty()) {
            medication.setError("Medication Route should not be empty");
            medication.requestFocus();
            return false;
        }else if(str.length() > 0 && str.startsWith(" ")) {
            medication.setText(medication.getText().toString().trim());
            medication.setSelection(medication.getText().length());
            return false;
        } else {
            return true;
        }
