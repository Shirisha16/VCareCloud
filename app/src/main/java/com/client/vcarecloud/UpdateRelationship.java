...
public class UpdateRelationship extends AppCompatActivity {
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_relationship);
        ...
        userDetails=new UserDetails(UpdateRelationship.this);
        ...
        relation.setText(lookupname);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(UpdateRelationship.this,Relationship.class);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lookupname=relation.getText().toString();
    ...
    private void updateRelationship() {
        ...
        call.enqueue(new Callback<UpdateLookupTypeResponse>() {
            ...
            public void onResponse(Call<UpdateLookupTypeResponse> call, Response<UpdateLookupTypeResponse> response) {
                if (response.code() == 200) {
                    if (response.body().getMessage() != null) {
                        ...
                        if (UpdateRelationship.this != null && !UpdateRelationship.this.isFinishing()) {
                            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(UpdateRelationship.this);
                        ...
                        Utils.showAlertDialog(UpdateRelationship.this,response.body().getErrorMessage(),false);
                    }
                }
            ...
            public void onFailure(Call<UpdateLookupTypeResponse> call, Throwable t) {
                Toast.makeText(UpdateRelationship.this, "Fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private boolean lookup_name() {
        String str = relation.getText().toString();
        if (relation.getText().toString().isEmpty()) {
            relation.setError("Relationship should not be empty");
            relation.requestFocus();
            return false;
        } else if(str.length() > 0 && str.startsWith(" ")) {
            relation.setText(relation.getText().toString().trim());
            relation.setSelection(relation.getText().length());
            return false;
        }
        else {
            return true;
